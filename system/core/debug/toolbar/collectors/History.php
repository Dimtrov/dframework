 ...
 * History
 *
 * History collector for debug toolbar
 *
 * @package		dFramework
 * @subpackage	Core
 ...
 * @since       3.3.0
 * @credit		CodeIgniter 4.0 - CodeIgniter\Debug\Toolbar\Collectors\History
 * @file		/system/core/debug/toolbar/collectors/History.php
 */
class History extends BaseCollector
{
	...
	{
		$filenames = glob(RESOURCE_DIR . 'reserved/debugbar/debugbar_*.json');
