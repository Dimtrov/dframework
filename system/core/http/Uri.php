...
class Uri
{
	...
	public function setURI(string $uri = null)
	{
		if (! is_null($uri))
		{
			...
			if ($parts === false)
			{
				HTTPException::show('Impossible de parser l\'URI "'.$uri.'"');
			}
	...
	public function getSegment(int $number): string
	{
		...
		{
			HTTPException::show('Le segment "'.$number.'" n\'est pas dans l\'interval de segment disponible');
		}
	...
	public function setPort(int $port = null)
	{
		...
		{
			HTTPException::show('Le port "'.$port.'" est invalide');
		}
	...
	public function setQuery(string $query)
	{
		...
		{
			HTTPException::show('La chaine de requete est mal formée');
		}
