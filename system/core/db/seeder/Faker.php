 ...
 * @file        /system/core/db/seeder/Faker.php
 */
class Faker
{    
    /**
    ...
    public function optional($weight = 0.5, $default = null) : self
    {
    ...
    public function unique(bool $reset = false, $maxRetries = 10000) : self
    {
